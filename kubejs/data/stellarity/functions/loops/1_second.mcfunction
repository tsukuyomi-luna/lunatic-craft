execute as @e[tag=stellarity.altar_of_accursed,tag=stellarity.aota_activated,type=marker] at @s run function stellarity:mechanics/altar_crafting/main
execute as @e[tag=stellarity.altar_of_the_light,type=marker] at @s run function stellarity:mechanics/altar_of_light/main
...
execute as @e[tag=stellarity.book_of_light.aura,type=marker] at @s as @a[distance=..5.5] run function stellarity:items/spellbooks/light/effects
