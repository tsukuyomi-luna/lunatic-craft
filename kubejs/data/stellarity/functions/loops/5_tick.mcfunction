...
execute at @e[tag=stellarity.eol,type=vindicator] run bossbar set stellarity:eol players @a[distance=..100]

# Shulker Armor Shulker Bullet targetting
execute as @e[tag=stellarity.defensive_shulker_bullet,type=minecraft:shulker_bullet] at @s run function stellarity:items/armors/shulker_armor/bullet_seek
