...
execute as @e[tag=stellarity.gloop,type=slime] at @s run function stellarity:mobs/gloop/main

# End Portal noises
execute as @e[tag=stellarity.end_portal,type=marker] at @s run function stellarity:visuals/end_portal_animation/ambient_sounds
