...
execute as @e[tag=stellarity.pixie,type=vex] at @s run function stellarity:mobs/pixie/loop
...
execute as @e[tag=stellarity.spirit_dagger.spirit,type=armor_stand] at @s anchored eyes positioned ^ ^ ^ run function stellarity:items/spirit_dagger/spirit/loop
...
# Starstruck Carcanet
execute as @e[tag=stellarity.carcanet.aec,type=area_effect_cloud] at @s run function stellarity:items/starstruck_carcanet/aec_loop
# Prismatic Pearl
...
# Tamaris
execute as @e[tag=stellarity.items.tamaris.executable,type=!#stellarity:invalid_targets] at @s anchored eyes rotated ~ 0 positioned ^ ^1.5 ^ run function stellarity:items/tamaris/execute/indicator
