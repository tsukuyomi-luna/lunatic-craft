...
execute if entity @e[tag=stellarity.eol.daytime,limit=1,sort=arbitrary] at @p run summon minecraft:area_effect_cloud ~ ~ ~ {Age:0,Duration:1,WaitTime:-2147483648,Tags:["stellarity.eol.ethereal_lance.pick_point","stellarity.eol.daytime"]}
