...
execute if entity @e[type=vindicator,tag=stellarity.eol.daytime,limit=1,sort=arbitrary] run tag @e[type=marker,limit=1,sort=nearest,tag=stellarity.eol.ethereal_lance] add stellarity.eol.ethereal_lance.gold
