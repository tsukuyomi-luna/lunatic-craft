...
execute if entity @e[type=!#stellarity:invalid_targets_with_player,distance=..9,tag=!stellarity.prismatic_blast.pierced,limit=1,sort=arbitrary] run scoreboard players set #continue stellarity.misc 1
...
scoreboard players set #times_done stellarity.misc 0
...
schedule function stellarity:items/prismatic_punch/detonate/piercing/scheduled 1t append
