...
execute anchored eyes unless entity @e[type=!#stellarity:invalid_targets_with_player,distance=..12,limit=1,sort=arbitrary] run function stellarity:items/prismatic_punch/move/main
...
# Detonation
execute anchored eyes if entity @e[type=!#stellarity:invalid_targets_with_player,distance=..2.5,limit=1,sort=arbitrary] if score @s stellarity.items.prismatic_punch.marker_age matches 5.. run function stellarity:items/prismatic_punch/detonate/check_self
execute anchored eyes if entity @e[type=player,distance=..2.5,limit=1,sort=arbitrary] if score @s stellarity.items.prismatic_punch.marker_age matches 8.. run function stellarity:items/prismatic_punch/detonate/check_self
