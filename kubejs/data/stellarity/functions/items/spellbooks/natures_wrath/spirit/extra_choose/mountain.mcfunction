...
execute if entity @e[type=!#stellarity:invalid_targets_with_player,distance=..13,limit=1,sort=arbitrary] run scoreboard players set #mob_count stellarity.misc 0
