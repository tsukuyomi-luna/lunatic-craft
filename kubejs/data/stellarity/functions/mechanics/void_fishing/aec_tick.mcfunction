...
execute unless entity @e[type=fishing_bobber,tag=stellarity.checked_bobber,distance=..2,limit=1,sort=arbitrary] run function stellarity:mechanics/void_fishing/stop
